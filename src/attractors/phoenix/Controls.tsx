  ...
  return (
    <Card>
      <ParameterGrid>
        ...
        <ParameterInputCompact label="C Real" value={params.cReal} onChange={handleChange("cReal")} disabled={disabled} step={0.001} />
        <ParameterInputCompact label="C Imag" value={params.cImag} onChange={handleChange("cImag")} disabled={disabled} step={0.001} />
      </ParameterGrid>
      <ParameterInputCompact label="P (Phoenix)" value={params.p} onChange={handleChange("p")} disabled={disabled} step={0.01} />
    </Card>
  );
};
